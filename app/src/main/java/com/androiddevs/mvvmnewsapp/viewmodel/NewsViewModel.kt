...
class NewsViewModel(app: Application, private val newsRepository: NewsRepository) :
    ...
    // memastikan koneksi ada atau tidak
    ...
    // todo = method untuk cek ketersediaan koneksi internet
    private fun hasInternetConnection(): Boolean {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            val capabilities = connectivityManager.getNetworkCapabilities(activateNetwork) ?: return false
            return when{
